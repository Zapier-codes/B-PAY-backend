...
pub struct ConnectorConfig {
    ...
    pub juicyway: Option<ConnectorTomlConfig>,
...
impl ConnectorConfig {
    ...
    pub fn get_connector_config(
        ...
        match connector {
            ...
            Connector::Flutterwave => Ok(connector_data.flutterwave),
            ...
            Connector::Juicyway => Ok(connector_data.juicyway),
            ...
            Connector::Korapay => Ok(connector_data.korapay),
