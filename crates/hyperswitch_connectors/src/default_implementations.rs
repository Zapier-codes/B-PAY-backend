...
macro_rules! default_imp_for_refund_void_post_refund {
    ($($path:ident::$connector:ident),*) => {
        $(
            impl hyperswitch_interfaces::api::refunds::RefundVoidPostRefund for $path::$connector {}

            impl ConnectorIntegration<
                hyperswitch_domain_models::router_flow_types::refunds::VoidPostRefund,
            ...
            > for $path::$connector
            {
                fn build_request(
                    &self,
                    _req: &hyperswitch_domain_models::types::RefundsRouterData<
                        hyperswitch_domain_models::router_flow_types::refunds::VoidPostRefund,
                    >,
                    _connectors: &hyperswitch_interfaces::configs::Connectors,
                ) -> CustomResult<
                ...
                > {
                    Err(hyperswitch_interfaces::errors::ConnectorError::NotImplemented(
                        "Void post-refund not implemented for this connector".to_string(),
                    )
                    .into())
                }
            }
...
default_imp_for_refund_void_post_refund!(
    connectors::AbsaSanlam,
    connectors::Aci,
    connectors::Adyen,
    connectors::Adyenplatform,
...
#[cfg(feature = "dummy_connector")]
impl<const T: u8> api::refunds::RefundVoidPostRefund for connectors::DummyConnector<T> {}
